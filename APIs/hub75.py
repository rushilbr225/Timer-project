...
class Hub75SpiConfiguration:
    ...
    def __init__(self):
        ...
        self.line_select_b_pin_number = 17
        self.line_select_c_pin_number = 33
        self.line_select_d_pin_number = 16
        self.line_select_e_pin_number = 5

        # Hub75 RGB data pins
        self.red1_pin_number = 27
        self.blue1_pin_number = 26
        self.green1_pin_number = 14
        self.red2_pin_number = 12
        self.blue2_pin_number = 25
        self.green2_pin_number = 15

        self.clock_pin_number = 0
        self.latch_pin_number = 2
        self.output_enable_pin_number = 4  # active low
